...
export function Sidebar({ className, isMobile = false, onClose }) {
  ...
  const sidebarContent = (
    <div className="space-y-3 sm:space-y-4 py-3 sm:py-4 h-full flex flex-col">
      <div className="px-3 sm:px-4 py-2">
        <div className="flex items-center justify-between mb-4 sm:mb-6 lg:mb-8">
          <div className="flex items-center space-x-2 sm:space-x-3 min-w-0">
            <Link href="/" className="flex-shrink-0 flex items-center" onClick={isMobile ? onClose : undefined}>
            <Image
             src="/Softiwo01.png"
             width={110}
             height={42}
          ...
          {isMobile && onClose && (
            <button
              onClick={onClose}
              className="p-1.5 sm:p-2 rounded-xl hover:bg-gray-100/80 dark:hover:bg-gray-800/80 shrink-0 transition-all duration-200 touch-target"
      ...
      <div className="px-2 space-y-1 sm:space-y-2 flex-1 overflow-y-auto">
          ...
          return (
            ...
            >
              <Link
                ...
                className={cn(
                  "group flex items-center space-x-2 sm:space-x-3 px-3 sm:px-4 py-3 sm:py-3.5 text-sm font-semibold rounded-xl transition-all duration-200 w-full relative overflow-hidden touch-target",
                  isActive
  ...
  if (isMobile) {
    return (
      <div className="fixed inset-0 z-50 lg:hidden">
        ...
        <div className="fixed left-0 top-0 h-full w-72 xs:w-80 sm:w-84 bg-white dark:bg-gray-950 shadow-2xl border-r border-gray-200 dark:border-gray-800">
          {sidebarContent}
        </div>
      </div>
    );
  ...
  return (
    <div className={cn(
      "hidden lg:block pb-12 min-h-screen w-56 xl:w-64 2xl:w-72 bg-white/50 backdrop-blur-sm border-r border-gray-200 dark:bg-gray-950/50 dark:border-gray-800",
      className
    )}>
      {sidebarContent}
    </div>
